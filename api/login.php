...
<body>
    <div class="benngoai">
        ...
        <form action="welcome.php" method="post" class="khung">
            <div class="bentrong">
                <h3>Đăng nhập vào tài khoản của bạn</h3>
                <div class="chỗnhập">
                    <p>Email hoặc số điện thoại</p>
                    <div class="box">
                        <input class="chữ" type="email" name="userL">
                    </div>
                    <div class="pass">
                        <p>Mật khẩu</p>
                        <a href="mod.html" class="quên">Quên mật khẩu?</a>
                    </div>
                    <div class="box">
                        <input class="chữ" type="password" name="passL">
                    </div>
                </div>
                <div class="nhớ">
                    <input type="checkbox" checked><span class="material-icons-round">done</span><p>Duy trì đăng nhập</p>
                </div>
                <div class="tiếptheo"><button>Tiếp theo</button></div>
            </div>
        </form>
    </div>
